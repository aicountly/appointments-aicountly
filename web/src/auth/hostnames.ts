 ...
 * appointments.aicountly.com and appointments.gh.aicountly.com. This is the fallback for
 * hosts the pattern does not cover — localhost above all.
 */
export const PRODUCT_KEY = (import.meta.env.VITE_PRODUCT_KEY ?? 'appointments').trim() || 'appointments'
...
/**
 * `appointments.aicountly.com` and `appointments.gh.aicountly.com` both resolve to
 * `appointments`, which is what the portal expects in authentication_jump.
 */
