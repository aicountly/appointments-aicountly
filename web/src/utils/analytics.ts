/**
 * Google Analytics 4 (gtag) for appointments.aicountly.com.
 *
 * Set at build time: VITE_GA4_SAAS_APPOINTMENTS_MEASUREMENT_ID=G-…
 * Flow backend: GA4_PROPERTY_ID_SAAS_APPOINTMENTS (numeric property ID).
 */
...
const GA4_ID: string =
  import.meta.env.VITE_GA4_SAAS_APPOINTMENTS_MEASUREMENT_ID ||
