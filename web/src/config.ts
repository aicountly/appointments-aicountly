...
export const APP_NAME = (import.meta.env.VITE_APP_NAME ?? 'Appointments').trim() || 'Appointments'
 ...
 * with the app on both appointments.aicountly.com and appointments.gh.aicountly.com. That
