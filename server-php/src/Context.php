 ...
 * on every confirmation email after somebody corrects it.
 *
 * NO FINANCIAL YEAR. Books, Sales and Purchases scope by `fy_id` because a
 * voucher belongs to an accounting period. An appointment does not: next
 * April's booking is made this March and nobody closes a year against it.
 * Requiring `fy_id` here would be cargo-cult scope.
 *
